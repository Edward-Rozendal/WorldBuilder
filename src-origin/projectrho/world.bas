...
710 IF P / 100 * AX > 12 THEN PRINT "THE BIG BANG OCCURED 12 BILLION YEARS AGO.":
INPUT "IS THIS WHAT YOU WANT"; A$: IF ASC(A$) <> 89 THEN 690
...
1410 SH = HI + 1.9 * TI * (1 + EC) ^ 2: LL = LO - 1.9 * TI / (1 + EC) ^ 2
